...
Процедура ОК(Команда)
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		...
		Результат.Вставить("Состояние" + ИмяРеквизита, ЭтотОбъект["Состояние" + ИмяРеквизита]);
		Результат.Вставить("Состояние" + ИмяРеквизита + "ID", ЭтотОбъект["Состояние" + ИмяРеквизита + "ID"]);
		Результат.Вставить("Состояние" + ИмяРеквизита + "Тип", ЭтотОбъект["Состояние" + ИмяРеквизита + "Тип"]);
	КонецЦикла;
...
Процедура ПрочитатьСостоянияДокумента(Параметры)
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		ИмяРеквизита = Реквизит.Ключ;
		ЭтотОбъект["Состояние" + ИмяРеквизита] = Параметры["Состояние" + ИмяРеквизита];
		ЭтотОбъект["Состояние" + ИмяРеквизита + "ID"] = Параметры["Состояние" + ИмяРеквизита + "ID"];
		ЭтотОбъект["Состояние" + ИмяРеквизита + "Тип"] = Параметры["Состояние" + ИмяРеквизита + "Тип"];
	КонецЦикла;
