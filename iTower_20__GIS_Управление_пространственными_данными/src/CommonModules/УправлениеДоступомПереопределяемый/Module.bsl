...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	// ГИС
	гисСтандартныеПодсистемы.ПриЗаполненииВидовДоступа(ВидыДоступа);
	// ГИС конец
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// ГИС
	гисСтандартныеПодсистемы.ПриЗаполненииСписковСОграничениемДоступа(Списки);
	// Конец ГИС
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// ГИС
	гисСтандартныеПодсистемы.ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание);
	// Конец ГИС
