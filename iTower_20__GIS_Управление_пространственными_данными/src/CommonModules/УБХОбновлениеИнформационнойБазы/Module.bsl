...
Функция ПолучитьИмяПодсистемы() Экспорт
	...
	Возврат "УправлениеБашеннымХозяйством";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = "УБХОбновлениеИнформационнойБазы.ОбновитьПредопределенныеВидыКонтактнойИнформации";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = "УБХОбновлениеИнформационнойБазы.ВыполнитьПервоначальноеЗаполнениеСправочников";
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	ХранилищеОбщихНастроек.Сохранить("ОбновлениеИБ", "ПоследняяВерсияОтображенияИзмененийСистемыУБХ", ПредыдущаяВерсия);
	ХранилищеОбщихНастроек.Сохранить("ОбновлениеИБ", "ТекущаяВерсияОтображенияИзмененийСистемыУБХ", ТекущаяВерсия);
КонецПроцедуры
...
Процедура ПриПодготовкеМакетаОписанияОбновлений(Макет) Экспорт
	...
	ОписаниеОбновлений = ПолучитьОбщийМакет("УБХОписаниеИзмененийСистемы");
	ОблатьОтступ = ОписаниеОбновлений.ПолучитьОбласть("Отступ");
	
	ПредыдущаяВерсия = ХранилищеОбщихНастроек.Загрузить("ОбновлениеИБ", "ПоследняяВерсияОтображенияИзмененийСистемыУБХ");
	ТекущаяВерсия = ХранилищеОбщихНастроек.Загрузить("ОбновлениеИБ", "ТекущаяВерсияОтображенияИзмененийСистемыУБХ");
...
Процедура ОбновитьПредопределенныеВидыКонтактнойИнформации() Экспорт
	...
	#Область СправочникКонтактныеЛица
	
	// Справочник "Контактные лица"
	ВидКИ = Справочники.ВидыКонтактнойИнформации.СправочникКонтактныеЛица.ПолучитьОбъект();
	ВидКИ.Используется = Истина;
	ВидКИ.Записать();
	
	// Почтовый адрес справочника "Контактная информация".
	...
	// Email адрес справочника "Контактная информация".
	...
	// Моб. телефон адрес справочника "Контактная информация".
	...
	ВидКИ = Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты.ПолучитьОбъект();
	ВидКИ.Используется = Истина;
	ВидКИ.Записать();
	...
	ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации.ВебСтраница;
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
	...
	#Область СправочникФизЛица
	
	// Справочник "ФизическиеЛица"
	ВидКИ = Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица.ПолучитьОбъект();
	ВидКИ.Используется = Истина;
	ВидКИ.Записать();

	// Почта.
	ПараметрыВида = УправлениеКонтактнойИнформацией.ПараметрыВидаКонтактнойИнформации(Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты);
	ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации.EmailФизЛицо;
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
	ПараметрыВида.Порядок = 1;
	УправлениеКонтактнойИнформацией.УстановитьСвойстваВидаКонтактнойИнформации(ПараметрыВида);
	...
	// Телефон.
	ПараметрыВида = УправлениеКонтактнойИнформацией.ПараметрыВидаКонтактнойИнформации(Перечисления.ТипыКонтактнойИнформации.Телефон);
	ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации.ТелефонРабочийФизЛицо;
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
	ПараметрыВида.Порядок = 2;
	УправлениеКонтактнойИнформацией.УстановитьСвойстваВидаКонтактнойИнформации(ПараметрыВида);
	...
	// Телефон мобильный.
	ПараметрыВида = УправлениеКонтактнойИнформацией.ПараметрыВидаКонтактнойИнформации(Перечисления.ТипыКонтактнойИнформации.Телефон);
	ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации.ТелефонМобильныйФизЛицо;
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
	ПараметрыВида.Порядок = 3;
	УправлениеКонтактнойИнформацией.УстановитьСвойстваВидаКонтактнойИнформации(ПараметрыВида);
...
Процедура ВыполнитьПервоначальноеЗаполнениеСправочников() Экспорт
	 Справочники.УБХРегионы.ПервоначальноеЗаполнениеСправочника();
КонецПроцедуры
