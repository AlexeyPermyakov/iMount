...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтрЗаменить(Заголовок, "%2", Параметры.Синоним);
	
	Если Не ЗначениеЗаполнено(Параметры.Синоним)  Тогда
		Заголовок = СтрЗаменить(Заголовок, """", "");
	КонецЕсли;
	
	РеквизитыОбъекта = СписокРеквизитовДляОтбора(Параметры.РеквизитыСтруктуры);
...
Процедура ОткрытьФормуВыбораРеквизита()
	...
	ОткрытьФорму("ОбщаяФорма.лм_ВыборРеквизита", ПараметрыФормы);
КонецПроцедуры
...
Процедура КомандаОк(Команда)
	...
	Результат.Вставить("ИдентификаторФормыВладельца", ИдентификаторФормыВладельца);
...
Процедура ЗависимостиРеквизитовУстановитьОграничениеТиповДляЗначения()
	...
	Если РежимВыбора = "Группы" Тогда
		ПолеВвода.ВыборГруппИЭлементов = ГруппыИЭлементы.Группы;
	ИначеЕсли РежимВыбора = "Элементы" Тогда
		ПолеВвода.ВыборГруппИЭлементов = ГруппыИЭлементы.Элементы;
	ИначеЕсли РежимВыбора = "ГруппыИЭлементы" Тогда
...
&НаСервере
Функция СписокРеквизитовДляОтбора(РеквизитыСтруктуры)
	
	РеквизитыОбъекта = Новый ТаблицаЗначений;
	РеквизитыОбъекта.Колонки.Добавить("Реквизит");
	РеквизитыОбъекта.Колонки.Добавить("Идентификатор", Новый ОписаниеТипов("УникальныйИдентификатор"));
	...
	РеквизитыОбъекта.Колонки.Добавить("РежимВыбора",   Новый ОписаниеТипов("Строка"));	
	
	Для Каждого Стр Из РеквизитыСтруктуры Цикл
		СтрТЗ = РеквизитыОбъекта.Добавить();
