...
Процедура ЗаполнитьФормуИзОбъектаXDTO(ПисьмоXDTO, НовоеПисьмо = Ложь)
	...
	Если ПисьмоXDTO.Установлено("answerType") Тогда
		Обработки.ИнтеграцияС1СДокументооборот.ЗаполнитьОбъектныйРеквизит(ЭтотОбъект, ПисьмоXDTO.answerType,"ТипОтвета");
	КонецЕсли;
	...
	Если ПисьмоXDTO.Установлено("baseObject") Тогда
		Обработки.ИнтеграцияС1СДокументооборот.ЗаполнитьОбъектныйРеквизит(ЭтотОбъект, ПисьмоXDTO.baseObject,"ПисьмоОснование");
	Иначе
		Элементы.ПисьмоОснование.Видимость = Ложь;
	КонецЕсли;
...
Процедура НачатьДобавлениеФайлаСДискаПоМассивуИмен(ПолныеИменаФайлов)
	...
	Файл.НачатьИнициализацию(
		Новый ОписаниеОповещения("НачатьДобавлениеФайлаСДискаПослеИнициализацииФайла",
			ЭтотОбъект, ПараметрыОповещения),
		ПараметрыОповещения.ОписанияФайлов[0].ПолноеИмяФайла);
